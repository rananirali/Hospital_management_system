...
public class FinalEditPatientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>FinalEdit Patient</title>");
            out.println("</head>");
            out.println("<body>");
            
            Bean user = new Bean(Integer.parseInt(request.getParameter("patient_id")),
