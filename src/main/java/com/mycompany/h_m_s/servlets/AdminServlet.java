...
public class AdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            Query<Doctor> query1 = session.createQuery("FROM Doctor", Doctor.class);
            doctors = query1.list();
        ...
        for (Doctor d : doctors) {
            ...
            out.println("<td>");
            out.println("<a href='" + request.getContextPath() + "/EditScreenServlet?id=" + d.getId() + "'>Edit</a> | ");
            out.println("<a href='" + request.getContextPath() + "/DeleteServlet?id=" + d.getId() + "' onclick=\"return confirm('Are you sure?')\">Delete</a>");
            out.println("</td>");
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            Query<Patient> query2 = session.createQuery("from Patient", Patient.class);
        ...
        for (Patient p : patients) {
            ...
            out.println("<td>");
            out.println("<a href='" + request.getContextPath() + "/EditScreenPatientServlet?id=" + p.getId() + "'>Edit</a> | ");
            out.println("<a href='" + request.getContextPath() + "/DeletePatientServlet?id=" + p.getId() + "' onclick=\"return confirm('Are you sure?')\">Delete</a>");
            out.println("</td>");
